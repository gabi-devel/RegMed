        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL))
        {
            ...
            if($stmt->rowCount() == 0)
            {
                ...
                try{
                    ...
                    $success = 'Su matrícula está pendiente de Verificación!';
                }
                                        ...
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
                                            <div class="row mb-3">
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-floating mb-3 mb-md-0 px-1">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-floating mb-3 mb-md-0 px-1">
                                                        <input class="form-control" name="apellido" id="inputLastName" type="text" placeholder="Inserte matricula" />
                                                        <label for="inputLastName">Matricula</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-floating mb-3 mb-md-0 px-1">
